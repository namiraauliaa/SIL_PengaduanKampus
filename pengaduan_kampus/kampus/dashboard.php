	...
	<tr>
		...
		<td>
			...
			<table border="3" class="responsive-table striped highlight">
				...
				<?php 
					$no=1;
					$pengaduan = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN masyarakat ON pengaduan.nim=masyarakat.nim INNER JOIN tanggapan ON pengaduan.id_pengaduan=tanggapan.id_pengaduan WHERE pengaduan.nim='".$_SESSION['data']['nim']."' ORDER BY pengaduan.id_pengaduan DESC");
